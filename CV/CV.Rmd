...
`r cat_tags(c("Computer Science", "Mathematical Statistics", "Modelling", "Bioinformatics", "Genomics", "Network Analysis", "Systems", "Pharmacometrics", "Data Science", "Computational Methods", "Simulation", "Artificial Intelligence", "Optimisation", "Artificial Neural Networks", "Neuroscience"))`

`r cat_tags(c("Databases", "High Performance Computing", "Functional Programming", "Cloud Computing", "Reproducible Research", "Software Quality", "Scientfic Software", "Commercial Software", "Analytics"))`
