...
```{r tags}
tags <- list(
  areas = c("Computer Science", "Mathematical Statistics", "Modelling", "Bioinformatics", "Genomics", "Network Analysis", "Systems", "Pharmacometrics", "Data Science", "Computational Methods", "Simulation", "Artificial Intelligence", "Optimisation", "Artificial Neural Networks", "Neuroscience"),
  technologies = c("Databases", "High Performance Computing", "Functional Programming", "Cloud Computing", "Reproducible Research", "Software Quality", "Scientfic Software", "Commercial Software", "Analytics"),
  social_coding = c("Agile Development", "Software Project Management", "Pair Programming", "Mentoring", "Scrum", "Git", "Docker", "DevOps", "Ansible"),
  languages = c("R", "Julia", "SQL", "Python", "Perl", "FORTRAN","C++", "C",  "Ruby", "Prolog", "Assembler", "JavaScript", "Java", "Objective-C", "TypeScript", "Swift", "Erlang", "Elixir")
  )

yaml::write_yaml(tags, here())
```
