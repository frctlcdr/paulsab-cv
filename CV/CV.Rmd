...
`r cat_tags(c("Agile Development", "Software Project Management", "Scrum", "Git", "Docker", "DevOps", "Ansible", "Pair Programming"))`
...
## This CV is written in R and Markdown, you can view the source code on github here:  [https://github.com/frctlcdr/paulsab-cv.git](https://github.com/frctlcdr/paulsab-cv.git)
